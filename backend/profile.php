            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-5">
                            <form action="profile_post.php" method="post">
                                <input type="text" class="form-control form-control-solid-bordered" name="name_cng" value="<?=$_SESSION['select_name'];?>">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <hr>
                        <div class="card-body pb-5">
                            <img class="mb-5" src="./uploads/dp/<?=$select_dp_assoc?>" height="80" width="80" alt="<?=$select_dp_assoc?>">
                ...
                <div class="col-xl-6" style="margin-top:-120px;">
                    <div class="card">
                        ...
                        <div class="card-body pb-5">
                            <form action="profile_post.php" method="post">
                                <input type="password" class="form-control form-control-solid-bordered" name="current_password" placeholder="Current Password">
                                <?php if(isset($_SESSION['pass_miss_match_error'])):?>
                                <p class="text-danger mt-3 ps-3">
                                    <?=$_SESSION['pass_miss_match_error'];?>
                                </p>
                                <?php endif;?>
                                <input type="password" class="form-control form-control-solid-bordered my-3" name="new_password" placeholder="New Password">
                                <input type="password" class="form-control form-control-solid-bordered" name="confirm_password" placeholder="Confirm New Password">
